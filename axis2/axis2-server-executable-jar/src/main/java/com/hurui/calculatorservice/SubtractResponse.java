...
/**
 *  SubtractResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SubtractResponse implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SubtractResponse".equals(type)) {
                            ...
                            return (SubtractResponse) com.hurui.calculatorservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
