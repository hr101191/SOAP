...
/**
 *  DivideResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DivideResponse implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DivideResponse".equals(type)) {
                            ...
                            return (DivideResponse) com.hurui.calculatorservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
